...
namespace kolbasik.NCommandBus.Http.Tests
{
    public class HttpCommandInvokerTests
    {
        ...
        public async Task Invoke_should_serialize_the_command_and_include_metadata()
        {
            ...
            // act
            await httpCommandInvoker.Invoke<TestResult, TestCommand>(context, CancellationToken.None).ConfigureAwait(false);
        ...
        public async Task Invoke_should_return_null_if_the_response_is_empty()
        {
            ...
            // act
            var actual = await httpCommandInvoker.Invoke<TestResult, TestCommand>(context, CancellationToken.None).ConfigureAwait(false);
